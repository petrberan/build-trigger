...
class BuildInfoTest {
    ...
    void testExceedingStreamLimit() {
        ...
        Assertions.assertTrue(thrown.getMessage().contains("The number of streams must be between 1 and"));
    }
    ...
    void testAnnotationInvalidStreamsSize() {
        ...
        Assertions.assertEquals(1, violations.size());
        Assertions.assertTrue(violations.iterator().next().getMessage().contains("The number of streams must be between 1 and"));
    }
    ...
    void testEmptyProjectVersion() {
        ...
        Assertions.assertEquals(1, violations.size());
        Assertions.assertEquals("Project version must not be blank.", violations.iterator().next().getMessage());
    }
